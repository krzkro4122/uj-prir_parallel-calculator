...
public class ParallelCalculator implements DeltaParallelCalculator {
    ...
    public void setThreadsNumber(int threads) {
        ...
        this.executorService = new ThreadPoolExecutor(threads, threads, 100L, TimeUnit.MILLISECONDS, new PriorityBlockingQueue<>(11, (o1, o2) -> Comparator.comparingInt(DataComparator::getId)
